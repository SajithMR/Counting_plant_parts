...
def make_dataset(img_dir, gam_dir, ann_dir):
    ...
    for img_name in sorted(os.listdir(img_dir)):
        ...
        gam_path = os.path.join(
            gam_dir, img_name) if gam_dir is not None else None
        count = get_num_lines(os.path.join(
...
class ImageFolder(data.Dataset):
    ...
    Args:
        ...
        loader (callable, optional): A function to load an image given its path.r
    Args:
